...
public class MQTTService extends Service {
    //消息服务器的URL
    public static final String BROKER_URL = "tcp://192.168.1.166:1883";
    //客户端ID，用来标识一个客户，可以根据不同的策略来生成
    public static final String clientId = "android-client";
    //订阅的主题名
    public static final String TOPIC = "device/4b2d3537-f9d8-462a-a6e9-6a37b32b0f8f";
    ...
    private String userName = "4b2d3537-f9d8-462a-a6e9-6a37b32b0f8f";
